...
namespace BL
{
    public class Usuario
    {
        ...
        public static ML.Result AddMySQL(ML.Usuario usuario)
        {
            ML.Result result = new ML.Result();
            ...
            try
            {
                ...
                {
                    var query = "INSERT INTO `Usuario`(`Nombre`, `ApellidoPaterno`, `ApellidoMaterno`, `FechaNacimiento`, `IdRol`) VALUES (@Nombre,@ApellidoPaterno,@ApellidoMaterno,@FechaNacimiento,@IdRol)";
        ...
        public static ML.Result Select()
        {
            ...
            try
            {
                using (MySqlConnection context = new MySqlConnection(DL_MySQL.Conexio.ConnectionString()))
                {
                    var query = "SELECT `IdUsuario`, `Nombre`, `ApellidoPaterno`, `ApellidoMaterno`, `FechaNacimiento`, Usuario.IdRol, Rol.NombreRol FROM `Usuario`INNER JOIN Rol on Usuario.IdRol = Rol.IdRol";
                    ...
                    using (MySqlCommand cmd = new MySqlCommand())
                    {
                        ...
                        mysqlDataAdapter.Fill(usuarioTable);
        ...
        public static ML.Result DeleteMySQL(int IdUsuario)
        {
            ML.Result result = new ML.Result();
            ...
            try
            {
                using (MySqlConnection context = new MySqlConnection(DL_MySQL.Conexio.ConnectionString()))
                {
                    var query = "DELETE FROM `Usuario` WHERE Usuario.IdUsuario = @IdUsuario";
                    ...
                    using (MySqlCommand cmd = new MySqlCommand())
                    {
                        ...
                        MySqlParameter[] collection = new MySqlParameter[1];

                        collection[0] = new MySqlParameter("IdUsuario", MySqlDbType.Int64);
                        collection[0].Value = IdUsuario;
        ...
        public static ML.Result SelectById(int IdUsuario)
        {
            ML.Result result = new ML.Result();
            ...
            try
            {
                using (MySqlConnection context = new MySqlConnection(DL_MySQL.Conexio.ConnectionString()))
                {
                    var query = "SELECT `IdUsuario`, `Nombre`, `ApellidoPaterno`, `ApellidoMaterno`, `FechaNacimiento`,`IdRol` FROM `Usuario` WHERE IdUsuario = @IdUsuario";
        ...
        public static ML.Result UpdateMySQL(ML.Usuario usuario)
        {
            ML.Result result = new ML.Result();
            ...
            try
            {
                using (MySqlConnection context = new MySqlConnection(DL_MySQL.Conexio.ConnectionString()))
                {
                    var query = "UPDATE `Usuario` SET `Nombre`=@Nombre,`ApellidoPaterno`=@ApellidoPaterno,`ApellidoMaterno`=@ApellidoMaterno,`FechaNacimiento`=@FechaNacimiento,`IdRol`=@IdRol WHERE IdUsuario = @IdUsuario";
                    ...
                    using (MySqlCommand cmd = new MySqlCommand())
                    {
                        ...
                        collection[4] = new MySqlParameter("FechaNacimiento", MySqlDbType.VarChar);
                        collection[4].Value = usuario.FechaNacimiento;

                        collection[5] = new MySqlParameter("IdRol", MySqlDbType.Int64);
                        collection[5].Value = usuario.Rol.IdRol;
